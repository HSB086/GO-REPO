...
type GreetServiceClient interface {
	...
	SayHelloBiDiractionalStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBiDiractionalStreamingClient, error)
}
...
func (c *greetServiceClient) SayHelloBiDiractionalStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBiDiractionalStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], "/greet_service.GreetService/SayHelloBiDiractionalStreaming", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceSayHelloBiDiractionalStreamingClient{stream}
	return x, nil
}

type GreetService_SayHelloBiDiractionalStreamingClient interface {
	Send(*HelloRequest) error
	Recv() (*HelloResponse, error)
	grpc.ClientStream
}

type greetServiceSayHelloBiDiractionalStreamingClient struct {
	grpc.ClientStream
}

func (x *greetServiceSayHelloBiDiractionalStreamingClient) Send(m *HelloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceSayHelloBiDiractionalStreamingClient) Recv() (*HelloResponse, error) {
	m := new(HelloResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreetServiceServer interface {
	...
	SayHelloBiDiractionalStreaming(GreetService_SayHelloBiDiractionalStreamingServer) error
...
func (UnimplementedGreetServiceServer) SayHelloBiDiractionalStreaming(GreetService_SayHelloBiDiractionalStreamingServer) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloBiDiractionalStreaming not implemented")
}
...
func _GreetService_SayHelloBiDiractionalStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloBiDiractionalStreaming(&greetServiceSayHelloBiDiractionalStreamingServer{stream})
}

type GreetService_SayHelloBiDiractionalStreamingServer interface {
	Send(*HelloResponse) error
	Recv() (*HelloRequest, error)
	grpc.ServerStream
}

type greetServiceSayHelloBiDiractionalStreamingServer struct {
	grpc.ServerStream
}

func (x *greetServiceSayHelloBiDiractionalStreamingServer) Send(m *HelloResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceSayHelloBiDiractionalStreamingServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SayHelloBiDiractionalStreaming",
			Handler:       _GreetService_SayHelloBiDiractionalStreaming_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
